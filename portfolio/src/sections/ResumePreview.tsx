...
const bgGradients = [
  "from-purple-900/30 via-indigo-900/30 to-blue-900/30 border-violet-500/30",
  "from-pink-900/30 via-red-900/30 to-orange-900/30 border-pink-500/30",
  "from-emerald-900/30 via-green-900/30 to-teal-900/30 border-green-500/30",
  "from-cyan-900/30 via-blue-900/30 to-indigo-900/30 border-cyan-500/30",
];
...
export function ResumePreview() {
  ...
  return (
    <div className="container md:py-20" id="resume">
      <div className="mt-6 mb-8 flex justify-center flex-col overflow-hidden">
        <SectionHeader
          tagIcon="solar:document-outline"
          tagText="Resume"
          showUnderline={true}
          centered={true}
          eyebrow="Resume Preview"
          title="My Professional Journey"
          description="Explore my skills, experience, and achievements in one place"
        />
        ...
        <motion.div className="relative max-w-5xl w-full" style={{ scale }}>
              ...
              <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6 mb-4 md:mb-6">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <p className="text-muted-foreground text-lg md:text-xl mb-1 md:mb-2">
                    MERN Stack Developer || AI
                  </p>
                  <p className="text-muted-foreground/80 text-sm md:text-base">
                    6 month+ experience in full-stack development
                  </p>
                </div>
                  ...
                  <div className="space-y-4 md:space-y-6">
                    <div className="border-l-2 border-blue-500/30 pl-3 md:pl-4">
                      ...
                      <ul className="text-xs md:text-sm text-muted-foreground/90 space-y-1 hidden md:block">
                        <li>
                          • Built responsive websites using Nodejs, React, and
                          JavaScript
                        </li>
                        <li>
                ...
                <div className="hidden md:block">
                  ...
                  <div className="space-y-4">
                    <div className="border-l-2 border-cyan-500/30 pl-4">
                      <h5 className="font-semibold text-base mb-1">Edumeet</h5>
                      <p className="text-sm text-muted-foreground/90 mb-2">
                        LMS, full-featured online course management platform.
                      </p>
                    ...
                    <div className="border-l-2 border-orange-500/30 pl-4">
                      ...
                      <p className="text-sm text-muted-foreground/90 mb-2">
                        Multi-language code editor with download, sharing and
                        save code.
                      </p>
                      <div className="flex flex-wrap gap-1">
                        <span className="bg-gray-100 text-gray-700 text-xs px-2 py-1 rounded">
          ...
          <div
            className={`absolute -top-4 -right-4 md:-top-6 md:-right-6 bg-gradient-to-r ${
              badgeGradients[(colorIndex + 2) % badgeGradients.length]
            } text-white px-3 py-2 md:px-4 md:py-2 rounded-lg md:rounded-xl font-semibold shadow-lg text-xs md:text-sm flex items-center gap-1 md:gap-2 transition-colors duration-500`}
          >
            Preview
          </div>
        </motion.div>
